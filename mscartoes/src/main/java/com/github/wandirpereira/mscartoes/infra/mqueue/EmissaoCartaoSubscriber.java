package com.github.wandirpereira.mscartoes.infra.mqueue;
...
import com.github.wandirpereira.mscartoes.domain.DadosSolicitacaoEmissaoCartao;
...
public class EmissaoCartaoSubscriber {
    ...
    public void receberSolicitacaoEmissao(@Payload String payload) {
        try {
            ...
            log.error("Erro ao receber solicitaca de emissao de cartoa: {}", e.getMessage());
        }
    }
}
